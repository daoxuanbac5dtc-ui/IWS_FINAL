...
<template>
    <div class="nike-complete-layout">
        ...
        <div class="breadcrumb-section bg-gray-50 py-4">
            <div class="mx-auto w-full px-6">
                <nav class="flex items-center space-x-2 text-sm">
                    <router-link to="/" class="text-gray-600 transition-colors hover:text-orange-500"> Trang chủ </router-link>
                    <span class="text-gray-400">/</span>
                    <router-link to="/profileInfo" class="text-gray-600 transition-colors hover:text-orange-500"> Thông tin của tôi </router-link>
                    <span v-if="getSubPageTitle()" class="text-gray-400">/</span>
                    <span v-if="getSubPageTitle()" class="font-medium text-gray-900">
                        {{ getSubPageTitle() }}
                    </span>
                </nav>
            </div>
        ...
        <main class="nike-layout w-full bg-gray-50 py-8">
            <div class="mx-auto w-full px-6">
                <div class="profile-container mx-auto max-w-7xl">
                        ...
                        <div class="lg:col-span-1">
                            <div class="rounded-lg bg-white p-6 shadow-sm">
                                ...
                                <div class="mb-6 text-center">
                                    <div class="mx-auto mb-3 flex h-20 w-20 items-center justify-center rounded-full bg-orange-500 text-2xl font-bold text-white">
                                ...
                                <nav class="space-y-1">
                                    ...
                                    <button @click="logout" class="flex w-full items-center gap-3 rounded-lg px-4 py-3 text-gray-600 transition-all duration-200 hover:bg-gray-50">
